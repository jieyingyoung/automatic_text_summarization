...
from Automatic_cntext_summary import AutomaticTextSummarizer
from Automatic_cntext_summary import load_model
...
path_cn = '../model/word2vec_normal_full.model'
model = load_model(path_cn)
